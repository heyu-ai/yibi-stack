# pr-review-convergence Specification

## Purpose

TBD - created by archiving change 'bound-review-loop-with-evidence-gate'. Update Purpose after archive.
...
<!-- @trace
source: bound-review-loop-with-evidence-gate
updated: 2026-07-18
code: []
-->
