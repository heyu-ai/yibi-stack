...
- Affected code：
  - Modified：`plugins/dev-cycle/skills/pr-retrospective/SKILL.md`（Step 5.0 Evidence Gate 段、Step 5 Q5→action 映射表加證據前置條件、Lesson Classifier 前置說明指向 Evidence Gate）
