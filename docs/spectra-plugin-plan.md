...
>
> **v0.2 更新（2026-05-16）**：plugin 改名為 `sdd`（`plugins/spectra/` → `plugins/sdd/`），
> PR review skills 移至 `plugins/dev-cycle/`，`qa-test-design` 移入 `sdd`。本文件記錄 v0.1
> 計畫，現況請以 `plugins/sdd/` 和 `plugins/dev-cycle/` 為準。
