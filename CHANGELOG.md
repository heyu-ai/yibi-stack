...
- add /agy standalone Gemini review skill
...
- fix markdownlint errors in SKILL.md (MD040 + MD036)
- clarify Step 0c allow-list hint to mention both entries
- address review findings (Critical + Important)
