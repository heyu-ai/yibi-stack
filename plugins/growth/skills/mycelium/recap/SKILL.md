...
```bash
# 列出最近 10 筆（預設）
mycelium recap list --project "$ORIG_PROJECT"

# 過濾特定 project
mycelium recap list --project yibi-stack

# 查單一 session 的時序軌跡
SESSION_ID="4c6cec93-a48c-4d8f-93b2-2ad43150c263"
mycelium recap list --session "$SESSION_ID" --project "$ORIG_PROJECT"
