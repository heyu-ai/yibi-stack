...
```bash
bash ~/.agents/skills/pr-review-cycle-mob/scripts/gemini-r1-stage2.sh
```
...
| Codex | `which codex` + auth | S1: `codex-r1-stage1.sh` / S2: `codex-r1-stage2.sh` / S3: lead renders codex-r1.md | `codex-r2.sh` | codex-r1.md（compact，非 raw） |
| Gemini *(optional)* | `which gemini` + auth | S1: `gemini-r1-stage1.sh` / S2: `gemini-r1-stage2.sh` / S3: lead renders gemini-r1.md | `gemini-r2.sh` | gemini-r1.md（compact，非 raw） |
